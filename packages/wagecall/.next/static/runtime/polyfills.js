(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
	["static/runtime/polyfills.js"],
	{
		/***/ "../../node_modules/next/dist/build/polyfills/polyfill-nomodule.js":
			/*!*************************************************************************************************!*\
  !*** /Users/ryansoury/dev/wagecall/node_modules/next/dist/build/polyfills/polyfill-nomodule.js ***!
  \*************************************************************************************************/
								...
								from: function (t) {
									...
									if (
										...
										for (
											...
											(a = l ? Ve(o, f, [n.value, p], !0) : n.value),
												Ye(r, p, a);
									return (r.length = p), r;
								}
							}
							...
							return [
								...
								function (t, n) {
									...
									for (var d = []; ; ) {
										...
										if ((d.push(v), !h)) break;
										"" === String(v[0]) &&
											(s.lastIndex = si(f, ut(s.lastIndex), p));
									}
									for (var g, y = "", m = 0, b = 0; b < d.length; b++) {
										v = d[b];
										for (
											var S = String(v[0]),
												w = li(hi(it(v.index), f.length), 0),
												E = [],
												x = 1;
											x < v.length;
											x++
									...
									[
										...
										function (t, o) {
											...
											for (var h = 0, p = 0, d = []; p < u.length; ) {
												...
												if (
													null === g ||
													(v = yi(ut(f.lastIndex + (mi ? 0 : p)), u.length)) ===
														h
												)
													p = si(u, p, s);
												else {
						...
						oc &&
							...
							(Lu = function () {
								var t = new Nu(),
									e = Vu(t);
								(this.promise = t),
									(this.resolve = hc(dc, t, e)),
									(this.reject = hc(pc, t, e));
							}),
							(Bu.f = tc = function (t) {
		...
		/***/ "../../node_modules/next/dist/client/polyfills.js":
			/*!********************************************************************************!*\
  !*** /Users/ryansoury/dev/wagecall/node_modules/next/dist/client/polyfills.js ***!
  \********************************************************************************/
			/*! no static exports found */
			/***/ function (module, exports, __webpack_require__) {
				"use strict";
